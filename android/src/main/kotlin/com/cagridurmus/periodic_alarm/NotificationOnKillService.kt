...
class NotificationOnKillService: Service() {
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        try {
            ...
            val notificationBuilder = NotificationCompat.Builder(this, "com.cagridurmus.periodic_alarm")
            ...
            val channel = NotificationChannel("com.cagridurmus.periodic_alarm", name, importance).apply {
